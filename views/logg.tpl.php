        ...
        <div class="navbar navbar-inverse navbar-static-top" role="navigation">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.php">Cuestionario</a>
                </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="container">
                ...
                <form action=index.php method=POST name=logg id=logg target='_self'>
                    <div class="col-lg-4" class="form-signin" role="form">
                        <?php echo utf8_decode($msg); ?>
                        ...
                        <input type="hidden" name="url" value="accss"/>
                </form>
